...
namespace ljgb.API.Controllers
{
    ...
    [ApiController]
    public class HargaSalesmanController:ControllerBase
    {
        private HargaSalesmanFacade facade = new HargaSalesmanFacade();
        [HttpPost]
        [Route("GetAll")]
        ...
        [HttpPost]
        [Route("AddPost")]
        public async Task<IActionResult> AddPost([FromBody]HargaSalesman model)
        {
        ...
        [HttpPost]
        [Route("UpdatePost")]
        public async Task<IActionResult> UpdatePost([FromBody]HargaSalesman model)
        {
            if (ModelState.IsValid)
            {
                try
